...
Today, thanks to a bug reported by a thoughtful musician, I found I had missed the BLOCKSIZE update to Peter's code that changes the frame size for each platform - the NTS platform binaries have not been correct until today (4/8); both ENV and LFO2 Binaries Zip's new contain working NTS binaries now - the others will have to wait few more days
