...
---------------
[NEW][1/17/26] sorry for the delay; with the new features, i've been playing a lot. now mod matrix alternates is up to four instead of two. each alternate is focused on one aspect of modulation, while coopting the LFO Int. knob for a new feature for each matrix: Key Tracking curves, special function LFO4, Modulation Balance, Quadrature Phase/Freq LFO. the special function maybe LFO duty cycle or something neat, this LFO and Quadrature, use the hardware LFO for phase/data instead of a builtin. Also, instancing AEG in a few places to reduce some redundancy. 
