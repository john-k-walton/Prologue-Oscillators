...
For me, these models have been hours, days, weeks, months, years now... of interesting discovery and manipulation. Both on the Modular hardware they were originally developed on, and as open source, early on ported to Prologue by Peter. Being able to express myself with them polyphonically has really been engaging. as to the oscilators themselves; for ease of use, every model within the same family, has the same control structure, and methods - learn one, learn them all! But in each model, the controls will take you in vastly different spaces.... and sometimes, you'll make some music along the way :0) enjoy! 
