...
For me, these models have been hours, days, weeks, months, years now... of interesting discovery and exploration. Both on the Modular hardware they were originally developed on, and as open source, early on ported to Prologue by Peter. Being able to express myself with them polyphonically has really been engaging. 
...
* ENV - this schema presents an indexed combinations of modulations using envelope, key tracking, and main LFO. key tracking can be used to cross fade modulations from Envelope to LFO. the LFO and Envelope may be summed, or multiplied together to produce delay vibrato like effects by enveloping the LFO. indicies with opposite slopes for key tracking modulations may be applied to sub and main layers for even more interesting intonations across the keyboard, or for very complex modulations.
